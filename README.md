...
2. Run `cd pycon-2020-web-app-testing` to enter the project.
...
*Example Branch: example/1-pytest-setup*
...
Finally, commit your code change. Section 1 is complete!
...
Then, commit your latest code changes. Section 3 is now complete!
...
Then, commit your latest code changes. Section 4 is now complete!
...
## Section 6: Configuring Multiple Browsers
...
## Section 7: Handling Race Conditions
...
This tutorial is based on several other tutorials and courses by Andrew Knight:

* Test Automation University: [Introduction to Selenium WebDriver with Python](https://testautomationu.applitools.com/)
